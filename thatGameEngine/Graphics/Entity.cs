...
namespace thatGameEngine
{
    ...
    public class Entity : Asset
    {
        ...
        {
            return new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("thatGameEngine.Data.entity.png"));
        }
            ...
            switch (assetType)
            {
                ...
                case AssetType.Sprite:
                    if (asset == null)
                    {
                        ...
                        texture.CreateFromBitmap(GetDefaultIcon(), "entity");
